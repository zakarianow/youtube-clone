...
const ChannelCard = ({channelDetail, marginTop}) => {
  ...
  return (
    <Box sx={{boxShadow: 'none', borderRadius: '0px', display: 'flex', justifyContent: 'center', alignItems: 'center', width: {md: '300px', sm: '300px', xs:'340px'},height: '286px', margin: 'auto', marginTop}}>
